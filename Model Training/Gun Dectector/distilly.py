...
DATA_YAML_PATH = r'A:\images\dataset\data.yaml'

# Path to your pre-trained YOLOv8-L teacher model weights.
TEACHER_MODEL_PATH = r'A:\model_checkpoints\gun_detector\gun_dectector_run35222\weights\best.pt'

# Directory where your new distilled models will be saved.
PROJECT_SAVE_DIR = r'A:\model_checkpoints\distilled-gun-detector'
...
RUN_NAME = 'distilled_yolov8s_from_L_gun_knife2222'
...
if __name__ == '__main__':
    ...
    if os.path.exists(resume_path):
        ...
        student_model = YOLO('yolov8s.yaml')
