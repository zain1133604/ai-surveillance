...
DATA_YAML_PATH = r'A:\New folder\project5_human_detection\data.yaml'

# Path to your pre-trained YOLOv8-L teacher model weights.
TEACHER_MODEL_PATH = r'A:\model_checkpoints\human-detector\gender_detection_run632\weights\best.pt'

# Directory where your new distilled models will be saved.
PROJECT_SAVE_DIR = r'A:\model_checkpoints\distill-human-detector'
...
RUN_NAME = 'distilled_yolov8n_from_L22'
